                    ...
                    <div class="card border-0 shadow mb-4">
                        <div class="card-body card-form p-4">
                            ...
                            <div class="mb-4">
                                ...
                                <textarea class="form-control" name="responsibility" id="responsibility" cols="5" rows="5" placeholder="Responsibilities">{{ $job->responsibility }}</textarea>
                            </div>
                            <div class="mb-4">
                            ...
                            <div class="mb-4">
                                ...
                                <select name="experience" id="experience" class="form-control">
                                    ...
                                    <option value="10_plus" {{ ($job->experience == '10 plus') ? 'selected' : '' }}>10+ years</option>
                                </select>
                                <p></p>
                            </div>
